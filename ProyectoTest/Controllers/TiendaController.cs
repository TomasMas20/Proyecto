...
namespace ProyectoTest.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult Obtenerpais()
        {
            ...
            oLista = UbigeoLogica.Instancia.Obtenerpais();
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult ObtenerProvincia(string _Idpais)
        {
            List<Provincia> oLista = new List<Provincia>();
            oLista = UbigeoLogica.Instancia.ObtenerProvincia(_Idpais);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult Obtenerciudad(string _IdProvincia,string _Idpais)
        {
            List<ciudad> oLista = new List<ciudad>();
            oLista = UbigeoLogica.Instancia.Obtenerciudad(_IdProvincia,_Idpais);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }
